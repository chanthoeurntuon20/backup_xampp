...
<article id="post-<?php the_ID(); ?>" <?php post_class('grid satrah'); ?>>


		<div class="featured-thumb md-4 sm-4">
			<?php if (has_post_thumbnail()) : ?>	
				<a href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail('satrah-thumb'); ?></a>
			<?php else: ?>
		...
		<div class="out-thumb md-8 sm-8">
			...
			<div class="postedon"><?php _e('Posted On','satrah'); ?> <?php satrah_posted_on_date(); ?></div>
		</div>
